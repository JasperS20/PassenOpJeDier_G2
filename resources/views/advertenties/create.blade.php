...
@section('content')
    ...
    <section class="profile-wrapper">
        <form class="profile-form" action="/advertenties" method="POST" enctype="multipart/form-data" style="margin:30px;">
            @csrf
            ...
            <div class="input-field adv-input-field">
                    ...
                    <textarea class="adv-textarea" name="description" cols="60" rows="7"></textarea>
                    @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
