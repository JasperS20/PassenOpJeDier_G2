...
<x-card>
    <section class="card">
        ...
        <section class="action-buttons">
            <div>
                <a href="/advertenties/{{$advertisements->id}}/bewerken" class="action-btn" href="" style="background-color: #ffffff; margin-top: 10px"><i class="fa-solid fa-pen-to-square"></i></a> 
            </div>
            <div>
